...
import { Library, Package, TrendingUp, DollarSign, Loader2, ListOrdered } from "lucide-react";
...
const Index = () => {
  const { allItems, itemsWithCalculated, addItem, updateItem, deleteItem, recordTransaction, clearAll: clearItems, getTotalItems, getTotalStock, getTotalSold, isLoading: isLoadingItems } = useItems();
